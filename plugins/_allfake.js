...
global.canalNombreM = ["ᐛ ᕕ  𝐘𝐨𝐭𝐬𝐮𝐛𝐚 - 𝐔𝐩𝐝𝐚𝐭𝐞𝐬 ᕗ ᐛ", "ᐛ ᕕ  𝐘𝐨𝐭𝐬𝐮𝐛𝐚 - 𝐘𝐩𝐝𝐚𝐭𝐞𝐬 ᕗ ᐛ"]
...
const iconoURL = 'https://causas-files.vercel.app/fl/j4si.jpg' 

let thumb = await (await fetch(iconoURL)).buffer().catch(() => null)
